...
/**
 * Javascript module for editing a callforpaper preset.
 *
 * @module      mod_callforpaper/editpreset
...
const showEditPresetModal = (editAction) => {
    const modalForm = new ModalForm({
        modalConfig: {
            title: getString('editpreset', 'mod_callforpaper'),
        },
        formClass: 'mod_callforpaper\\form\\save_as_preset',
        args: {
            d: editAction.getAttribute('data-callforpaperid'),
