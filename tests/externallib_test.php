...
use mod_callforpaper_external;

/**
 * Call for paper module external functions tests
 *
 ...
 * @since      Moodle 2.9
 * @coversDefaultClass \mod_callforpaper_external
 */
final class externallib_test extends \core_external\tests\externallib_testcase {
    ...
    /** @var  stdClass Test callforpaper activity. */
    protected $callforpaper;
    ...
    public function setUp(): void {
        ...
        $this->callforpaper = $this->getDataGenerator()->create_module('callforpaper', array('course' => $this->course->id));
        $this->context = \context_module::instance($this->callforpaper->cmid);
    ...
    /**
     * Add a test field to the callforpaper activity instance to be used in the unit tests.
     *
     * @return \callforpaper_field_base
     */
    protected function add_test_field(): \callforpaper_field_base {
        ...
        return $generator->create_field($fieldrecord, $this->callforpaper);
    }

    /**
     * Test get callforpapers by courses
     */
    public function test_mod_callforpaper_get_callforpapers_by_courses(): void {
        global $DB;
        ...
        $callforpaper1 = self::getDataGenerator()->create_module('callforpaper', $record);

        // Second callforpaper.
        $record = new \stdClass();
        $record->introformat = FORMAT_HTML;
        $record->course = $course2->id;
        $callforpaper2 = self::getDataGenerator()->create_module('callforpaper', $record);
        ...
        $callforpaper1->coursemodule = $callforpaper1->cmid;
        $callforpaper1->introfiles = [];
        $callforpaper1->lang = '';
        $callforpaper2->coursemodule = $callforpaper2->cmid;
        $callforpaper2->introfiles = [];
        $callforpaper2->lang = '';
        ...
        foreach ($expectedfields as $field) {
            if ($field == 'approval' or $field == 'manageapproved') {
                $callforpaper1->{$field} = (bool) $callforpaper1->{$field};
                $callforpaper2->{$field} = (bool) $callforpaper2->{$field};
            }
            $expected1[$field] = $callforpaper1->{$field};
            $expected2[$field] = $callforpaper2->{$field};
        }
        ...
        $expectedcallforpapers = array();
        $expectedcallforpapers[] = $expected2;
        $expectedcallforpapers[] = $expected1;

        // Call the external function passing course ids.
        $result = mod_callforpaper_external::get_callforpapers_by_courses(array($course2->id, $course1->id));
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_callforpapers_by_courses_returns(), $result);
        $this->assertEquals($expectedcallforpapers, $result['callforpapers']);

        // Call the external function without passing course id.
        $result = mod_callforpaper_external::get_callforpapers_by_courses();
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_callforpapers_by_courses_returns(), $result);
        $this->assertEquals($expectedcallforpapers, $result['callforpapers']);

        // Unenrol user from second course and alter expected callforpapers.
        $enrol->unenrol_user($instance2, $student->id);
        array_shift($expectedcallforpapers);
        ...
        $result = mod_callforpaper_external::get_callforpapers_by_courses(array($course2->id));
        ...
        foreach ($additionalfields as $field) {
            ...
            $expectedcallforpapers[0][$field] = $callforpaper1->{$field};
        }
        $result = mod_callforpaper_external::get_callforpapers_by_courses();
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_callforpapers_by_courses_returns(), $result);
        $this->assertEquals($expectedcallforpapers, $result['callforpapers']);
        ...
        $result = mod_callforpaper_external::get_callforpapers_by_courses(array($course1->id));
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_callforpapers_by_courses_returns(), $result);
        $this->assertEquals($expectedcallforpapers, $result['callforpapers']);
    }

    /**
     * Test view_callforpaper invalid id.
     */
    public function test_view_callforpaper_invalid_id(): void {

        // Test invalid instance id.
        $this->expectException('moodle_exception');
        mod_callforpaper_external::view_callforpaper(0);
    }

    /**
     * Test view_callforpaper not enrolled user.
     */
    public function test_view_callforpaper_not_enrolled_user(): void {
    ...
    /**
     * Test view_callforpaper no capabilities.
     */
    public function test_view_callforpaper_no_capabilities(): void {
        // Test user with no capabilities.
        // We need a explicit prohibit since this capability is allowed for students by default.
        assign_capability('mod/callforpaper:view', CAP_PROHIBIT, $this->studentrole->id, $this->context->id);
    ...
    /**
     * Test view_callforpaper.
     */
    public function test_view_callforpaper(): void {
        ...
        $result = mod_callforpaper_external::view_callforpaper($this->callforpaper->id);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::view_callforpaper_returns(), $result);
        ...
        $this->assertInstanceOf('\mod_callforpaper\event\course_module_viewed', $event);
        $this->assertEquals($this->context, $event->get_context());
        $moodledata = new \moodle_url('/mod/callforpaper/view.php', array('id' => $this->cm->id));
    ...
    /**
     * Test get_callforpaper_access_information for student.
     */
    public function test_get_callforpaper_access_information_student(): void {
        global $DB;

        // Add a field to callforpaper to let users add new entries.
        $this->add_test_field();

        // Modify the callforpaper to add access restrictions.
        $this->callforpaper->timeavailablefrom = time() + DAYSECS;
        $this->callforpaper->requiredentries = 2;
        $this->callforpaper->requiredentriestoview = 2;
        $DB->update_record('callforpaper', $this->callforpaper);

        // Test user with full capabilities.
        $this->setUser($this->student1);

        $result = mod_callforpaper_external::get_callforpaper_access_information($this->callforpaper->id);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_callforpaper_access_information_returns(), $result);
        ...
        $this->assertEquals($this->callforpaper->requiredentries, $result['entrieslefttoadd']);
        $this->assertEquals($this->callforpaper->requiredentriestoview, $result['entrieslefttoview']);
    }

    /**
     * Test get_callforpaper_access_information for teacher.
     */
    public function test_get_callforpaper_access_information_teacher(): void {
        global $DB;
    ...
    /**
     * Test get_callforpaper_access_information with groups.
     */
    public function test_get_callforpaper_access_information_groups(): void {
        global $DB;
        ...
        $result = mod_callforpaper_external::get_callforpaper_access_information($this->callforpaper->id, $this->group2->id);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_callforpaper_access_information_returns(), $result);
    ...
    /**
     * Helper method to populate the callforpaper with some entries.
     *
     * @return array the entry ids created
     */
    public function populate_callforpaper_with_entries() {
        global $DB;

        // Force approval.
        $DB->set_field('callforpaper', 'approval', 1, array('id' => $this->callforpaper->id));
        $generator = $this->getDataGenerator()->get_plugin_generator('mod_callforpaper');
        ...
        foreach ($fieldtypes as $fieldtype) {
            ...
            $generator->create_field($record, $this->callforpaper);
            $count++;
        }
        // Get all the fields created.
        $fields = $DB->get_records('callforpaper_fields', array('callforpaperid' => $this->callforpaper->id), 'id');
        ...
        $this->setUser($this->student1);
        $entry11 = $generator->create_entry($this->callforpaper, $fieldcontents, $this->group1->id, ['Cats', 'Dogs']);
        $this->setUser($this->student2);
        $entry12 = $generator->create_entry($this->callforpaper, $fieldcontents, $this->group1->id, ['Cats']);
        $entry13 = $generator->create_entry($this->callforpaper, $fieldcontents, $this->group1->id);
        // Entry not in group.
        $entry14 = $generator->create_entry($this->callforpaper, $fieldcontents, 0);

        $this->setUser($this->student3);
        $entry21 = $generator->create_entry($this->callforpaper, $fieldcontents, $this->group2->id);

        // Approve all except $entry13.
        $DB->set_field('callforpaper_records', 'approved', 1, ['id' => $entry11]);
        $DB->set_field('callforpaper_records', 'approved', 1, ['id' => $entry12]);
        $DB->set_field('callforpaper_records', 'approved', 1, ['id' => $entry14]);
        $DB->set_field('callforpaper_records', 'approved', 1, ['id' => $entry21]);
    ...
    public function test_get_entries(): void {
        ...
        // Check the behaviour when the callforpaper has no entries.
        $result = mod_callforpaper_external::get_entries($this->callforpaper->id);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertEmpty($result['entries']);

        $result = mod_callforpaper_external::get_entries($this->callforpaper->id, 0, true);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertEmpty($result['entries']);
        $this->assertEmpty($result['listviewcontents']);

        // Add a few fields to the callforpaper.
        list($entry11, $entry12, $entry13, $entry14, $entry21) = self::populate_callforpaper_with_entries();
        ...
        $this->assertEquals($this->callforpaper->id, $result['entries'][0]['callforpaperid']);
        ...
        $this->assertEquals($this->callforpaper->id, $result['entries'][1]['callforpaperid']);
        ...
        $this->assertEquals($this->callforpaper->id, $result['entries'][2]['callforpaperid']);
        ...
        $entries = $DB->get_records('callforpaper_records', array('callforpaperid' => $this->callforpaper->id), 'id');
        ...
        $this->setUser($this->student1);
        $result = mod_callforpaper_external::get_entries($this->callforpaper->id, $this->group1->id);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        $this->setUser($this->student1);
        $result = mod_callforpaper_external::get_entries($this->callforpaper->id, $this->group1->id, false, null, 'DESC');
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        // Test pagination.
        $this->setUser($this->student1);
        $result = mod_callforpaper_external::get_entries($this->callforpaper->id, $this->group1->id, false, null, null, 0, 1);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_callforpaper_external::get_entries($this->callforpaper->id, $this->group1->id, false, null, null, 1, 1);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(1, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        callforpaper_generate_default_template($this->callforpaper, 'listtemplate', 0, false, true); // Generate a default list template.
        $result = mod_callforpaper_external::get_entries($this->callforpaper->id, $this->group1->id, true, null, null, 0, 2);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(2, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
    ...
    public function test_get_entry_visible_groups(): void {
        ...
        $this->setUser($this->student1);
        $result = mod_callforpaper_external::get_entry($entry11);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_callforpaper_external::get_entry($entry21);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
    ...
    public function test_get_entry_separated_groups(): void {
        ...
        // Retrieve contents.
        callforpaper_generate_default_template($this->callforpaper, 'singletemplate', 0, false, true);
        $result = mod_callforpaper_external::get_entry($entry11, true);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_callforpaper_external::get_entry($entry12);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_callforpaper_external::get_entry($entry13);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entry_returns(), $result);
    ...
    public function test_get_fields(): void {
        ...
        $this->setUser($this->student1);
        $result = mod_callforpaper_external::get_fields($this->callforpaper->id);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_fields_returns(), $result);
    ...
    /**
     * Test get_fields_callforpaper_without_fields.
     */
    public function test_get_fields_callforpaper_without_fields(): void {
    ...
    public function test_search_entries(): void {
        ...
        $result = mod_callforpaper_external::search_entries($this->callforpaper->id, 0, false);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::search_entries_returns(), $result);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);

        // Search for something that does not exists.
        $result = mod_callforpaper_external::search_entries($this->callforpaper->id, 0, false, 'abc');
        $result = external_api::clean_returnvalue(mod_callforpaper_external::search_entries_returns(), $result);
        $this->assertCount(0, $result['entries']);
        $this->assertEquals(0, $result['totalcount']);

        // Search by text matching all the entries.
        $result = mod_callforpaper_external::search_entries($this->callforpaper->id, 0, false, 'text');
        $result = external_api::clean_returnvalue(mod_callforpaper_external::search_entries_returns(), $result);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        $this->setUser($this->student2);
        $result = mod_callforpaper_external::search_entries($this->callforpaper->id, 0, false, 'text', [], CALLFORPAPER_APPROVED, 'ASC');
        $result = external_api::clean_returnvalue(mod_callforpaper_external::search_entries_returns(), $result);
        ...
        // Pagination.
        $this->setUser($this->teacher);
        $result = mod_callforpaper_external::search_entries($this->callforpaper->id, 0, false, 'text', [], CALLFORPAPER_TIMEADDED, 'ASC', 0, 2);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::search_entries_returns(), $result);
        ...
        $result = mod_callforpaper_external::search_entries($this->callforpaper->id, 0, false, '', $advsearch);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::search_entries_returns(), $result);
        $this->assertCount(2, $result['entries']);
        $this->assertEquals(2, $result['totalcount']);
        $this->assertEquals(3, $result['maxcount']);
        ...
        $field = $DB->get_record('callforpaper_fields', array('type' => 'url'));
        $advsearch = [
        ...
        // Combined search.
        $field2 = $DB->get_record('callforpaper_fields', array('type' => 'number'));
        $advsearch = [
            ['name' => 'f_' . $field->id , 'value' => 'sampleurl'],
    ...
    public function test_approve_entry(): void {
        ...
        $this->setUser($this->teacher);
        $this->assertEquals(0, $DB->get_field('callforpaper_records', 'approved', array('id' => $entry13)));
        $result = mod_callforpaper_external::approve_entry($entry13);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::approve_entry_returns(), $result);
        $this->assertEquals(1, $DB->get_field('callforpaper_records', 'approved', array('id' => $entry13)));
    }
    ...
    public function test_unapprove_entry(): void {
        ...
        $this->setUser($this->teacher);
        $this->assertEquals(1, $DB->get_field('callforpaper_records', 'approved', array('id' => $entry11)));
        $result = mod_callforpaper_external::approve_entry($entry11, false);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::approve_entry_returns(), $result);
        $this->assertEquals(0, $DB->get_field('callforpaper_records', 'approved', array('id' => $entry11)));
    }
    ...
    public function test_approve_entry_missing_permissions(): void {
        ...
        $this->setUser($this->student1);
        $this->expectException('moodle_exception');
        mod_callforpaper_external::approve_entry($entry13);
    }
    ...
    public function test_delete_entry_as_teacher(): void {
        ...
        $this->setUser($this->teacher);
        $result = mod_callforpaper_external::delete_entry($entry11);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::delete_entry_returns(), $result);
        $this->assertEquals(0, $DB->count_records('callforpaper_records', array('id' => $entry11)));

        // Entry in other group.
        $result = mod_callforpaper_external::delete_entry($entry21);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::delete_entry_returns(), $result);
        $this->assertEquals(0, $DB->count_records('callforpaper_records', array('id' => $entry21)));
    }
    ...
    public function test_delete_entry_as_student_in_read_only_period(): void {
        ...
        list($entry11, $entry12, $entry13, $entry14, $entry21) = self::populate_callforpaper_with_entries();
        // Set a time period.
        $this->callforpaper->timeviewfrom = time() - HOURSECS;
        $this->callforpaper->timeviewto = time() + HOURSECS;
        $DB->update_record('callforpaper', $this->callforpaper);

        $this->setUser($this->student1);
        $this->expectException('moodle_exception');
        mod_callforpaper_external::delete_entry($entry11);
    }
    ...
    public function test_delete_entry_missing_permissions(): void {
        ...
        $this->setUser($this->student1);
        $this->expectException('moodle_exception');
        mod_callforpaper_external::delete_entry($entry21);
    }
    ...
    public function test_add_entry(): void {
        ...
        $result = mod_callforpaper_external::add_entry($this->callforpaper->id, 0, $newentrydata);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::add_entry_returns(), $result);

        $newentryid = $result['newentryid'];
        $result = mod_callforpaper_external::get_entry($newentryid, true);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::get_entry_returns(), $result);
        ...
        foreach ($result['entry']['contents'] as $content) {
            ...
            $dbcontent = $DB->get_record('callforpaper_content', array('fieldid' => $field->id, 'recordid' => $newentryid));
        ...
        $this->assertEquals(get_string('errormustsupplyvalue', 'callforpaper'), $result['fieldnotifications'][0]['notification']);
    }
    ...
    public function test_add_entry_empty_form(): void {
        ...
        $result = mod_callforpaper_external::add_entry($this->callforpaper->id, 0, []);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::add_entry_returns(), $result);
        $this->assertEquals(0, $result['newentryid']);
        $this->assertCount(1, $result['generalnotifications']);
        $this->assertCount(0, $result['fieldnotifications']);
        $this->assertEquals(get_string('emptyaddform', 'callforpaper'), $result['generalnotifications'][0]);
    }
    ...
    public function test_add_entry_read_only_period(): void {
        ...
        $this->setUser($this->student1);
        $this->expectExceptionMessage(get_string('noaccess', 'callforpaper'));
        $this->expectException('moodle_exception');
        mod_callforpaper_external::add_entry($this->callforpaper->id, 0, []);
    }
    ...
    public function test_add_entry_max_num_entries(): void {
        ...
        list($entry11, $entry12, $entry13, $entry14, $entry21) = self::populate_callforpaper_with_entries();
        // Set a time period.
        $this->callforpaper->maxentries = 1;
        $DB->update_record('callforpaper', $this->callforpaper);
    ...
    public function test_add_entry_invalid_group(): void {
        ...
        $this->expectExceptionMessage(get_string('noaccess', 'callforpaper'));
        $this->expectException('moodle_exception');
        mod_callforpaper_external::add_entry($this->callforpaper->id, $this->group2->id, []);
    }

    /**
     * Test add_entry for an empty callforpaper (no fields).
     *
     * @covers ::add_entry
     */
    public function test_add_entry_empty_callforpaper(): void {
        $this->expectException('moodle_exception');
        mod_callforpaper_external::add_entry($this->callforpaper->id, 0, []);
    }
    ...
    public function test_update_entry(): void {
        ...
        $result = mod_callforpaper_external::update_entry($entry11, $newentrydata);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::update_entry_returns(), $result);
        ...
        foreach ($result['entry']['contents'] as $content) {
            $field = $fields[$content['fieldid']];
            // Stored content same that the one retrieved by WS.
            $dbcontent = $DB->get_record('callforpaper_content', array('fieldid' => $field->id, 'recordid' => $entry11));
            $this->assertEquals($dbcontent->content, $content['content']);
    ...
    /**
     * Test update_entry sending empty callforpaper.
     */
    public function test_update_entry_empty_callforpaper(): void {
        list($entry11, $entry12, $entry13, $entry14, $entry21) = self::populate_callforpaper_with_entries();

        $this->setUser($this->student1);
        $result = mod_callforpaper_external::update_entry($entry11, []);
        $result = external_api::clean_returnvalue(mod_callforpaper_external::update_entry_returns(), $result);
        $this->assertFalse($result['updated']);
        $this->assertCount(1, $result['generalnotifications']);
    ...
    public function test_update_entry_read_only_period(): void {
        ...
        $this->expectExceptionMessage(get_string('noaccess', 'callforpaper'));
        $this->expectException('moodle_exception');
        mod_callforpaper_external::update_entry($entry11, []);
    }
    ...
    public function test_get_entry_rating_information(): void {
        ...
        $DB->set_field('callforpaper', 'assessed', RATING_AGGREGATE_SUM, array('id' => $this->callforpaper->id));
        $DB->set_field('callforpaper', 'scale', 100, array('id' => $this->callforpaper->id));
        list($entry11, $entry12, $entry13, $entry14, $entry21) = self::populate_callforpaper_with_entries();
        ...
        $rating1->component = 'mod_callforpaper';
        ...
        $rating2->component = 'mod_callforpaper';
