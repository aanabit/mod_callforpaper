...
use mod_callforpaper\completion\custom_completion;
...
/**
 * Class for unit testing mod_callforpaper/activity_custom_completion.
 *
 * @package   mod_callforpaper
 * @copyright Simey Lameze <simey@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
final class custom_completion_test extends advanced_testcase {
    ...
    /**
     * Call for paper provider for get_state().
     *
     * @return array[]
     */
    ...
    /**
     * Call for paper provider for test_get_available_custom_rules().
     *
     * @return array[]
     */
