...
final class entries_importer_test extends \advanced_testcase {
     ...
     *
     * @covers \mod_callforpaper\local\importer\entries_importer::get_file_content_from_zip
     * @covers \mod_callforpaper\local\importer\entries_importer::get_callforpaper_file_content
     * @dataProvider get_file_content_from_zip_provider
     * @param array $files array of filenames and filecontents to test
     * @param mixed $callforpaperfilecontent the expected result returned by the method which is being tested here
     */
    public function test_get_file_content_from_zip(array $files, mixed $callforpaperfilecontent): void {
        ...
        $this->assertEquals($callforpaperfilecontent, $importer->get_callforpaper_file_content());
        unlink($zipfilepath);
    }

    /**
     * Call for paper provider method for self::test_get_file_content_from_zip.
     *
    ...
    public static function get_file_content_from_zip_provider(): array {
        return [
            'some files in the zip archive' => [
                ...
                'callforpaperfilecontent' => 'some,csv,data'
            ],
            'wrongly placed data file' => [
                ...
                // Call for paper file is not in the root directory, though no content should be retrieved.
                'callforpaperfilecontent' => false
            ],
