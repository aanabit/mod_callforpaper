...
Feature: Users can navigate through the callforpaper activity using the tertiary navigation
  In order to use the callforpaper module
  As a user
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | callforpaper     | Call for paper without fields | Call for paper intro | C1     | callforpaper2    |
    ...
    And the following "mod_callforpaper > entries" exist:
      ...
      | callforpaper1    | teacher1  | Teacher entry 1      | Some content 1  |
      | callforpaper1    | teacher1  | Teacher entry 2      | Some content 2  |
    And the following "mod_callforpaper > presets" exist:
      | callforpaper | name                      | description                          | user      |
      | callforpaper1    | Saved preset by teacher1  | This preset has also a description   | teacher1  |
  ...
  @javascript
  Scenario: The tertiary navigation in the Call for paper page.
    Given I navigate to "Call for paper" in current page administration
    # Teacher: List view.
    Then I should not see "List view" in the "callforpaper-listview-content" "region"
    ...
    And I should not see "Single view" in the "callforpaper-singleview-content" "region"
    And the "Import entries" item should exist in the "Actions" action menu of the ".tertiary-navigation" "css_element"
    And the "Export entries" item should exist in the "Actions" action menu of the ".tertiary-navigation" "css_element"
    And the "Export to portfolio" item should not exist in the "Actions" action menu of the ".tertiary-navigation" "css_element"
    # Teacher: Call for paper without fields.
    And I am on the "Call for paper without fields" "callforpaper activity" page
    ...
    But the following "mod_callforpaper > entries" exist:
      | callforpaper | user      | field1               | field2          |
      | callforpaper1    | student1  | Student entry 3      | Some content 3  |
    And I should not see "Actions" in the ".tertiary-navigation" "css_element"
  ...
  Scenario: The tertiary navigation in the Presets page.
    ...
    # Call for paper without fields.
    But I am on the "Call for paper without fields" "callforpaper activity" page
