...
Feature: Users can view and manage callforpaper presets
  ...
  Background:
    ...
    And the following "mod_callforpaper > presets" exist:
      ...
      | callforpaper1    | Saved preset 1           | The preset1 has description        | admin    |
      | callforpaper1    | Saved preset 2           |                                    | admin    |
  ...
  Scenario: Admins can delete saved presets
    Given I am on the "Mountain landscapes" "callforpaper activity" page logged in as admin
    ...
    And the "Delete" item should not exist in the "Actions" action menu of the "Journal" "table_row"
  ...
  Scenario: Teachers can see and use presets
    ...
    Then I should see "Choose a preset to use as a starting point."
    And I should see "Journal"
    And I should see "Use this preset for a journal" in the "Journal" "table_row"
    And I should see "Saved preset 1"
  ...
  Scenario: Only users with the viewalluserpresets capability can see presets created by other users
    Given the following "permission override" exists:
      | role         | editingteacher              |
      | capability   | mod/callforpaper:viewalluserpresets |
      | permission   | Prohibit                    |
      | contextlevel | System                      |
      | reference    |                             |
    When I am on the "Mountain landscapes" "callforpaper activity" page logged in as teacher1
  ...
  Scenario: Teachers can edit presets
    ...
    Then the "Edit" item should not exist in the "Actions" action menu of the "Journal" "table_row"
  ...
  Scenario: Teachers can edit presets and overwrite them if they are the authors
    Given the following "mod_callforpaper > preset" exists:
      | callforpaper    | callforpaper1                                |
  ...
  Scenario: Teachers can delete their own presets
    ...
    And the following "mod_callforpaper > presets" exist:
      | callforpaper | name                     | description                     | user     |
      | callforpaper1    | Saved preset by teacher1 | My funny description goes here. | teacher1 |
    And I am on the "Mountain landscapes" "callforpaper activity" page logged in as teacher1
    When I follow "Presets"
    And I should see "Journal"
    And I should see "Saved preset 1"
  ...
  Scenario: Teachers can export any saved preset
    ...
    And the "Export" item should not exist in the "Actions" action menu of the "Journal" "table_row"
  ...
  Scenario Outline: Admins and Teachers can load a preset from a file
    Given I am on the "Mountain landscapes" "callforpaper activity" page logged in as <user>
    When I follow "Presets"
