...
Feature: Call for paper with no calendar capabilites
  In order to allow work effectively
  As a teacher
  I need to be able to create callforpapers even when I cannot edit calendar events
  ...
  Scenario: Editing a callforpaper
    Given I log in as "admin"
    And the following "activities" exist:
      | activity   | name                 | intro                       | course | section | idnumber |
      | callforpaper       | Test callforpaper name   | Test callforpaper description   | C1     | 1       | callforpaper1    |
    ...
    And I press "Save and return to course"
    Then I should see "Test callforpaper name"
