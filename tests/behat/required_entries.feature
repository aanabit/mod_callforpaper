...
Feature: Users can be required to specify certain fields when adding entries to callforpaper activities
  In order to constrain user input
  As a teacher
  I need to specify certain fields as required when I add entries to callforpapers
  ...
  Background:
    ...
    And the following "mod_callforpaper > fields" exist:
      | callforpaper | type        | name                          | required | description                   | param1                         |
      | callforpaper1    | text        | Base Text input               | 1        | Base Text input               |                                |
      | callforpaper1    | checkbox    | Required Checkbox             | 1        | Base Text input               | Required Checkbox Option 1     |
      | callforpaper1    | checkbox    | Required Two-Option Checkbox  | 1        | Required Two-Option Checkbox  | RTOC Option 1\nRTOC Option 2   |
      | callforpaper1    | menu        | Required Menu                 | 1        | Required Menu                 | Option 1                       |
      | callforpaper1    | number      | Required Number               | 1        | Required Number               |                                |
      | callforpaper1    | radiobutton | Required Radio                | 1        | Required Radio                | Required Radio Option 1        |
      | callforpaper1    | text        | Required Text input           | 1        | Required Text input           |                                |
      | callforpaper1    | textarea    | Required Text area            | 1        | Required Text area            |                                |
      | callforpaper1    | url         | Required URL                  | 1        | Required URL                  |                                |
      | callforpaper1    | multimenu   | Required Multimenu            | 1        | Required Multimenu            | Option 1                       |
      | callforpaper1    | multimenu   | Required Two-Option Multimenu | 1        | Required Two-Option Multimenu | Option 1\nOption 2             |
      | callforpaper1    | checkbox    | Not required Checkbox         | 0        | Not required Checkbox         | Not required Checkbox Option 1 |
      | callforpaper1    | menu        | Not required Menu             | 0        | Not required Menu             | Option 1                       |
      | callforpaper1    | number      | Not required Number           | 0        | Not required Number           |                                |
      | callforpaper1    | radiobutton | Not required Radio            | 0        | Not required Radio            | Not required Radio Option 1    |
      | callforpaper1    | text        | Not required Text input       | 0        | Not required Text input       |                                |
      | callforpaper1    | textarea    | Not required Text area        | 0        | Not required Text area        |                                |
      | callforpaper1    | url         | Not required URL              | 0        | Not required URL              |                                |
      | callforpaper1    | multimenu   | Not required Multimenu        | 0        | Not required Multimenu        | Option 1                       |

  Scenario: Students receive errors for empty required fields but not for optional fields
    Given I am on the "Test callforpaper name" "callforpaper activity" page logged in as student1
...
#    Then ".alert" "css_element" should exist in the "//div[contains(@id,'defaulttemplate-addentry']//div[position()=1]]" "xpath_element"
    ...
    And I follow "Test callforpaper name"
  ...
  Scenario: Students receive no error for filled in required fields
    ...
    Then I should not see "No entries in callforpaper"
    And I should see "New entry text"

  Scenario: Fields refill with callforpaper after having an error
    Given I am on the "Test callforpaper name" "callforpaper activity" page logged in as student1
    And I click on "Add entry" "button"
    And I set the following fields to these values:
       | RTOC Option 1                 | 1                   |
