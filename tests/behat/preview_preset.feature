...
Feature: Users can preview presets
  ...
  As a teacher
  I need to preview the callforpaper activity presets
  ...
  Scenario: Preview a user preset as list view template in callforpaper
    Given I follow "Presets"
    And I click on "Actions" "button"
    And I choose "Import preset" in the open action menu
    And I upload "mod/callforpaper/tests/fixtures/behat_preset.zip" file to "Preset file" filemanager
  ...
  @javascript @_file_upload
  Scenario: Preview a user preset as single view template in callforpaper
    Given I follow "Presets"
    And I click on "Actions" "button"
    And I choose "Import preset" in the open action menu
    And I upload "mod/callforpaper/tests/fixtures/behat_preset.zip" file to "Preset file" filemanager
  ...
  @javascript
  Scenario: Preview a plugin preset in callforpaper
    Given I follow "Presets"
  ...
  @javascript
  Scenario: Use back button to return to the presets page in callforpaper
    Given I follow "Presets"
    And I click on "Journal" "link"
    And I should see "Journal"
    When I click on "Back" "button"
    Then I should see "Choose a preset to use as a starting point."

  @javascript
  Scenario: Apply plugin preset from preview in callforpaper
    Given I follow "Presets"
    And I click on "Journal" "link"
  ...
  @javascript @_file_upload
  Scenario: Apply user preset from preview in callforpaper
    Given I follow "Presets"
    And I click on "Actions" "button"
    And I choose "Import preset" in the open action menu
    And I upload "mod/callforpaper/tests/fixtures/behat_preset.zip" file to "Preset file" filemanager
