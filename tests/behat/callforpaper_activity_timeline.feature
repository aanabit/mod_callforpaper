...
Feature: Students can view upcoming callforpaper activities in the timeline block
  In order for student to see upcoming callforpaper activities in timeline block
  As a teacher
  I should be able to set the availability dates of callforpaper activities
  ...
  @javascript
  Scenario Outline: Student can view upcoming callforpaper activities in the timeline block
    Given the following "activities" exist:
      | activity | course | name       | id_timeavailablefrom_enabled | timeavailablefrom | id_timeavailableto_enabled | timeavailableto     |
      | callforpaper     | C1     | DB Past    | 1                            | <pastfrom>        | 1                          | <pastto>            |
      | callforpaper     | C1     | DB Future  | 1                            | <futurefrom>      | 1                          | <futureto>          |
      | callforpaper     | C1     | DB No date | 0                            |                   | 0                          |                     |
