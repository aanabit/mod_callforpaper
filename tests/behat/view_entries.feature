...
Feature: Users can view and search callforpaper entries
  In order to find the callforpaper entries that I am looking for
  As a user
  I need to list and search the callforpaper entries
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | callforpaper     | Test callforpaper name | Call for paper intro | C1     | callforpaper1    |
    And the following "mod_callforpaper > fields" exist:
      ...
      | callforpaper1    | url  | Test field 3 name | Test field 3 description |

  @javascript
  Scenario: Students can view, list and search entries
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | Test field name | Test field 2 name | Test field 3 name      |
      | callforpaper1    | Student entry 1 |                   | https://moodledev.io   |
      | callforpaper1    | Student entry 2 |                   |                        |
      | callforpaper1    | Student entry 3 |                   |                        |
    When I log in as "student1"
    And I am on the "Test callforpaper name" "callforpaper activity" page
  ...
  Scenario: Check that searching by tags works as expected
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | Test field name                 | Test field 2 name                 | Test field 3 name |
      | callforpaper1    | student1 | Student original entry untagged | Student original entry untagged 2 |                   |
    ...
    And I set the field with xpath "//div[@class='callforpapertagcontrol']//input[@type='text']" to "Tag1"
    And I press "Save"
    ...
    When I click on "Save settings" "button" in the "callforpaper_adv_form" "region"
  ...
  Scenario: Check that searching by first and last name works as expected
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | Test field name | Test field 2 name | Test field 3 name |
      | callforpaper1    | student1 | Student entry 1 |                   |                   |
      | callforpaper1    | student2 | Student entry 2 |                   |                   |
    When I am on the "Test callforpaper name" "callforpaper activity" page logged in as teacher1
    And I click on "Advanced search" "checkbox"
  ...
  @javascript
  Scenario: Call for paper entries can be deleted in batch if delcheck is present
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | Test field name | Test field 2 name      | Test field 3 name |
      | callforpaper1    | student1 | Student entry 1 | Some student content 1 | http://moodle.com |
      | callforpaper1    | teacher1 | Teacher entry 2 | Some teacher content 2 | http://moodle.com |
    ...
    When I navigate to "Call for paper" in current page administration
  ...
  @javascript
  Scenario: Call for paper entries cannot be deleted in batch if delcheck is not present
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | Test field name | Test field 2 name      | Test field 3 name |
      | callforpaper1    | student1 | Student entry 1 | Some student content 1 | http://moodle.com |
      | callforpaper1    | teacher1 | Teacher entry 2 | Some teacher content 2 | http://moodle.com |
  ...
  Scenario Outline: Entries are linked based on autolink and open in new window settings
    ...
    Given the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name              | param1   | param3   |
      | callforpaper1    | url  | URL field name    | <param1> | <param3> |
    And the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | Test field name  | Test field 2 name  | Test field 3 name   | URL field name |
      | callforpaper1    | teacher1 | Test field entry | Test field 2 entry | http://example.com/ | www.moodle.org |
    When I am on the "Test callforpaper name" "callforpaper activity" page logged in as teacher1
  ...
  Scenario: Check the accessibility of the callforpaper entries page (zero state)
    When I am on the "Test callforpaper name" "callforpaper activity" page logged in as "teacher1"
    Then I should see "No entries yet"
    And the page should meet accessibility standards

  @javascript @accessibility
  Scenario: Check the accessibility of the callforpaper entries page
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | Test field name | Test field 2 name      | Test field 3 name |
      | callforpaper1    | student1 | Student entry 1 | Some student content 1 | http://moodle.com |
      | callforpaper1    | teacher1 | Teacher entry 2 | Some teacher content 2 | http://moodle.com |
