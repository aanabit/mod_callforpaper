...
Feature: Users can use mod_callforpaper without editing the templates
  ...
  Background:
    ...
    And the following "mod_callforpaper > entries" exist:
      ...
      | callforpaper1    | Student entry 2 | Some content 2 |
  ...
  Scenario: The default view templates should be updated when a field is added.
    ...
    When the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name   | description              |
      | callforpaper1    | text | field3 | Test field 3 description |
    Then I navigate to "Call for paper" in current page administration
    And I should see "field1"
    And I should see "field2"
  ...
  Scenario: The dynamic default templates can be reset after a manual edition.
    ...
    And I should see "Student entry 1"
    And I should see "Some content 1"
    Then the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name   | description              |
      | callforpaper1    | text | field3 | Test field 3 description |
    And I navigate to "Call for paper" in current page administration
    And I click on "Add entry" "button"
