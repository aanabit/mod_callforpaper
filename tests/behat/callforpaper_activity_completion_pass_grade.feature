@mod @mod_callforpaper @core_completion
Feature: Completion pass grade
  View activity completion in the callforpaper activity
  ...
  @javascript
  Scenario: Call for paper module completion conditions are displayed regardless of the view
#   We add an entry to let the user change to a different view.
  ...
  @javascript
  Scenario: Student cannot complete a callforpaper activity if one of the conditions are not met
  ...
  @javascript
  Scenario: Student can complete a callforpaper activity when all conditions are met
    Given I am on the "Music history" "callforpaper activity" page logged in as student1
    And the "View" completion condition of "Music history" is displayed as "done"
    And the "Make entries: 2" completion condition of "Music history" is displayed as "todo"
    And the "Receive a grade" completion condition of "Music history" is displayed as "todo"
