...
Feature: Users can edit the callforpaper templates
  ...
  Background:
    ...
    And the following "mod_callforpaper > entries" exist:
      | callforpaper | field1          | field2         |
      | callforpaper1    | Student entry 1 | Some content 1 |
  ...
  @javascript
  Scenario: Reset callforpaper activity template
    Given I set the following fields to these values:
      | Header         | New header!                  |
  ...
  @javascript
  Scenario: Reset all callforpaper templates using the action menu
    Given the following "mod_callforpaper > templates" exist:
      | callforpaper | name            | content        |
      | callforpaper1    | singletemplate  | Initial single |
      | callforpaper1    | listtemplate    | Initial list   |
      | callforpaper1    | addtemplate     | Initial add    |
      | callforpaper1    | asearchtemplate | Initial search |
    And I navigate to "Call for paper" in current page administration
  ...
  @javascript
  Scenario: Reset all callforpaper templates using the reset template button
    Given the following "mod_callforpaper > templates" exist:
      | callforpaper | name            | content        |
      | callforpaper1    | singletemplate  | Initial single |
      | callforpaper1    | listtemplate    | Initial list   |
