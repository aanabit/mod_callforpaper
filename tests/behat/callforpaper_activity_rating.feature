...
Feature: Enable activity rating according to chosen grading scale
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | callforpaper     | C1     | DB activity 1 | db1      |
  ...
  Scenario: View ratings in the course gradebook
    Given I am on the "DB activity 1" "callforpaper activity editing" page logged in as teacher1
    ...
    And the following "mod_callforpaper > entries" exist:
      | callforpaper | user     | DB field   |
      | db1      | student1 | S1 entry 1 |
      | db1      | student1 | S1 entry 2 |
      | db1      | student2 | S2 entry 1 |
    And I am on the "DB activity 1" "callforpaper activity" page
