@mod @mod_callforpaper @javascript
Feature: Users can use predefined presets
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | callforpaper     | Mountain landscapes | introduction... | C1     | callforpaper1    |
  ...
  Scenario: Using a preset on a non empty callforpaper could create new fields
  ...
  Scenario: Using a preset on a non-empty callforpaper could show the option to map fields
    Given the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name            |
  ...
  Scenario: Teacher can use a preset from presets page on a callforpaper with existing entries
    # Creating an entry to test use a preset feature with callforpapers with entries.
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | Test field name |
  ...
  Scenario: Using a preset from preset preview page on a non empty callforpaper could create new fields
    Given the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name    |
      | callforpaper1    | text | title   |
    And I am on the "Mountain landscapes" "callforpaper activity" page logged in as teacher1
  ...
  Scenario: Using a preset from preset preview page on a non-empty callforpaper could show the option to map fields
    Given the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name            |
      | callforpaper1    | text | oldtitle        |
    And I am on the "Mountain landscapes" "callforpaper activity" page logged in as teacher1
  ...
  Scenario: Teacher can use a preset from preset preview page on a callforpaper with existing entries
    # Creating an entry to test use a preset feature with callforpapers with entries.
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | Test field name |
      | callforpaper1    | Student entry 1 |
  ...
  Scenario: Apply preset dialogue should show helpful information to the user
    Given the following "activities" exist:
      | activity | name           | intro           | course | idnumber |
      | callforpaper     | Sea landscapes | introduction... | C1     | callforpaper2    |
    And the following "mod_callforpaper > fields" exist:
      | callforpaper | type | name            |
      | callforpaper2    | text | title        |
    And I am on the "Sea landscapes" "callforpaper activity" page logged in as teacher1
    And I follow "Presets"
    And I click on "Image gallery" "link"
    When I click on "Use this preset" "button"
    And I should see "Apply preset Image gallery"
    ...
    And the following "mod_callforpaper > fields" exist:
      | callforpaper     | type      | name          |
      | callforpaper2        | textarea  | description   |
      | callforpaper2        | picture   | image         |
    And I click on "Image gallery" "link"
    And I click on "Use this preset" "button"
    And I should see "Apply preset Image gallery"
  ...
  Scenario: Teacher can use a preset on a non-empty callforpaper and previous fields will be removed
    Given I am on the "Mountain landscapes" "callforpaper activity" page logged in as teacher1
    And I follow "Fields"
