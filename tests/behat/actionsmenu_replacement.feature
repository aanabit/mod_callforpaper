...
Feature: Users can add the ##actionsmenu## replacement to the callforpaper templates
  ...
  Scenario: The ##actionsmenu## replacement displays the expected actions with default settings depending on the user permissions
    ...
    But I am on the "Test callforpaper name" "callforpaper activity" page logged in as student1
    And I open the action menu in "Student entry 1" "table_row"
    And I should see "Show more"
    And I should see "Edit"
    And I should see "Delete"
  ...
  Scenario: The Delete option in the ##actionsmenu## replacement is working
    Given the following "mod_callforpaper > entries" exist:
      | callforpaper | user         | field1           | field2                 |
      | callforpaper1    | student1     | Student entry 2  | Some student content 2 |
      | callforpaper1    | teacher1     | Teacher entry 2  | Some teacher content 2 |
