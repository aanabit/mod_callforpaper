...
Feature: Zero state page (no fields created)
  ...
  Scenario: Teachers see buttons to manage callforpaper when there is no field created on view page
    Given I am on the "Test callforpaper name" "callforpaper activity" page logged in as "teacher1"
  ...
  @javascript
  Scenario: Teachers see buttons to manage callforpaper when there is no field created on templates page
    Given I am on the "Test callforpaper name" "callforpaper activity" page logged in as "teacher1"
    And "Import a preset" "button" should exist
  ...
  @javascript
  Scenario: Teacher can use a preset from zero state page on an empty callforpaper
    Given I am on the "Test callforpaper name" "callforpaper activity" page logged in as "teacher1"
    And I click on "Use a preset" "button"
    ...
    And I should see "Short text" in the "Title" "table_row"

  @javascript @accessibility
  Scenario: Check the accessibility of the callforpaper activity zero state
