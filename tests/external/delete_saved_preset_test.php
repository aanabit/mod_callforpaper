 ...
 * @coversDefaultClass \mod_callforpaper\external\delete_saved_preset
 */
final class delete_saved_preset_test extends \core_external\tests\externallib_testcase {
    /**
    ...
    public function test_delete_saved_preset(): void {
        ...
        $result = delete_saved_preset::execute($callforpaper->id, [$preset1name, $preset2name]);
        ...
        $result = delete_saved_preset::execute($callforpaper->id, ['Another preset']);
        $result = external_api::clean_returnvalue(delete_saved_preset::execute_returns(), $result);
        $this->assertFalse($result['result']);
        ...
        $this->setUser($teacher);
        $result = delete_saved_preset::execute($callforpaper->id, [$preset2name]);
        $result = external_api::clean_returnvalue(delete_saved_preset::execute_returns(), $result);
        ...
        $this->setUser($teacher);
        $result = delete_saved_preset::execute($callforpaper->id, [$preset1name]);
        $result = external_api::clean_returnvalue(delete_saved_preset::execute_returns(), $result);
        $this->assertFalse($result['result']);
        $this->assertCount(1, $result['warnings']);
        // Check no preset has been deleted.
