 ...
 * @coversDefaultClass \mod_callforpaper\external\get_mapping_information
 */
final class get_mapping_information_test extends \advanced_testcase {

    /**
     * callforpaper provider for test_get_mapping_information().
     *
     * @return array[]
     */
    ...
    public function test_get_mapping_information(
        ...
        $this->assertEquals($result['callforpaper']['fieldstocreate'], $fieldstocreate);
        $this->assertEquals($result['callforpaper']['fieldstoremove'], $fieldstoremove);
    ...
    public function test_get_mapping_information_for_wrong_preset(): void {
        ...
        $this->assertFalse(array_key_exists('callforpaper', $result));
        ...
        $this->assertTrue(array_key_exists('callforpaper', $result));
