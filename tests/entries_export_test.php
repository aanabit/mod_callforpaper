...
use context_module;
use mod_callforpaper\local\exporter\csv_entries_exporter;
use mod_callforpaper\local\exporter\ods_entries_exporter;
use mod_callforpaper\local\exporter\utils;
...
final class entries_export_test extends \advanced_testcase {
    ...
    protected function get_test_data(): array {
        ...
        $callforpaper = $generator->create_instance(['course' => $course->id]);
        ...
        $numberfield = $generator->create_field($fieldrecord, $callforpaper);

        $fieldrecord->name = 'textfield';
        $fieldrecord->type = 'text';
        $textfield = $generator->create_field($fieldrecord, $callforpaper);

        $fieldrecord->name = 'filefield1';
        $fieldrecord->type = 'file';
        $filefield1 = $generator->create_field($fieldrecord, $callforpaper);

        $fieldrecord->name = 'filefield2';
        $fieldrecord->type = 'file';
        $filefield2 = $generator->create_field($fieldrecord, $callforpaper);

        $fieldrecord->name = 'picturefield';
        $fieldrecord->type = 'picture';
        $picturefield = $generator->create_field($fieldrecord, $callforpaper);
        ...
        $generator->create_entry($callforpaper, $contents);
    ...
    /**
     * Tests the exporting of the content of a mod_callforpaper instance by using the csv_entries_exporter.
     *
     * It also includes more general testing of the functionality of the entries_exporter the csv_entries_exporter
     * is inheriting from.
     *
     * @covers \mod_callforpaper\local\exporter\entries_exporter
     * @covers \mod_callforpaper\local\exporter\entries_exporter::get_records_count()
     * @covers \mod_callforpaper\local\exporter\entries_exporter::send_file()
     * @covers \mod_callforpaper\local\exporter\csv_entries_exporter
     * @covers \mod_callforpaper\local\exporter\utils::callforpaper_exportdata
     */
    public function test_export_csv(): void {
        ...
        $fieldrecords = $DB->get_records('callforpaper_fields', ['callforpaperid' => $callforpaper->id], 'id');
        ...
        $includefiles = false;
        utils::callforpaper_exportdata($callforpaper->id, $fields, $selectedfields, $exporter, $currentgroup, $context,
            $exportuser, $exporttime, $exportapproval, $tags, $includefiles);
        $this->assertEquals(file_get_contents(self::get_fixture_path(__NAMESPACE__, 'test_callforpaper_export_without_files.csv')),
        ...
        $expectedfilecontents = [
            // The test generator for mod_callforpaper uses a copy of field/picture/pix/sample.png as sample file content for the
            ...
            'files/samplefile.png' => 'public/mod/callforpaper/field/picture/pix/sample.png',
            'files/samplefile_1.png' => 'public/mod/callforpaper/field/picture/pix/sample.png',
            'files/picturefile.png' => 'public/mod/callforpaper/field/picture/pix/sample.png',
            ...
            'testexportfile.csv' => self::get_fixture_path(__NAMESPACE__, 'test_callforpaper_export_with_files.csv'),
        ];
     ...
     *
     * @covers \mod_callforpaper\local\exporter\ods_entries_exporter
     * @covers \mod_callforpaper\local\exporter\utils::callforpaper_exportdata
     */
