...
/**
 * Tests for Call for paper activity overview
 *
...
final class overview_test extends \advanced_testcase {
    ...
    /**
     * callforpaper provider for test_get_actions_overview.
     *
     * @return \Generator
     */
    public static function provider_test_get_actions_overview(): \Generator {
        ...
        yield 'Teacher with entries (require approval)' => [
            ...
            'entries' => [1, 0],
            'expected' => [
                'link' => get_string('approve', 'callforpaper'),
                'value' => 1,
            ],
        ];
    ...
    /**
     * callforpaper provider for test entry related extras.
     *
     * @return \Generator
     */
    ...
    /**
     * callforpaper provider for test comments extras.
     *
     * @return \Generator
     */
