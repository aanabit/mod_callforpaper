...
/**
 * Preset importer tests class for mod_callforpaper.
 *
 * @package    mod_callforpaper
 * @category   test
 * @copyright  2022 Amaia Anabitarte <amaia@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_callforpaper\local\importer\preset_importer
 */
final class preset_importer_test extends \advanced_testcase {
    ...
    public static function preset_importer_provider(): array {
        ...
        return [
            'Empty callforpaper / Empty importer' => [
                'currentfields' => [],
                'newfields' => [],
                'pluginname' => '',
            ],
    ...
    /**
     * Call for paper provider for needs_mapping().
     *
     * @return array[]
     */
    public static function needs_mapping_provider(): array {
        ...
        $basedprovider['Empty callforpaper / Empty importer']['expectedresult'] = false;
        $basedprovider['Empty callforpaper / Importer with fields']['expectedresult'] = false;
        $basedprovider['Call for paper with fields / Empty importer']['expectedresult'] = true;
    ...
    /**
     * Call for paper provider for test_set_affected_fields().
     *
     * @return array[]
     */
    public static function set_affected_provider(): array {
        ...
        $basedprovider['Empty callforpaper / Empty importer']['fieldstocreate'] = 0;
        $basedprovider['Empty callforpaper / Empty importer']['fieldstoremove'] = 0;
        $basedprovider['Empty callforpaper / Empty importer']['fieldstoupdate'] = 0;

        $basedprovider['Empty callforpaper / Importer with fields']['fieldstocreate'] = 3;
        $basedprovider['Empty callforpaper / Importer with fields']['fieldstoremove'] = 0;
        $basedprovider['Empty callforpaper / Importer with fields']['fieldstoupdate'] = 0;

        $basedprovider['Call for paper with fields / Empty importer']['fieldstocreate'] = 0;
        $basedprovider['Call for paper with fields / Empty importer']['fieldstoremove'] = 3;
        $basedprovider['Call for paper with fields / Empty importer']['fieldstoupdate'] = 0;
    ...
    /**
     * Call for paper provider for get_field_names().
     *
     * @return array[]
     */
    ...
    public function test_create_from_plugin_or_directory(): void {
        ...
        $this->assertInstanceOf('\mod_callforpaper\local\importer\preset_existing_importer', $preset);
