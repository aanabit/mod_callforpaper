...
/**
 * Preset tests class for mod_callforpaper.
 *
 * @package    mod_callforpaper
 * @category   test
 * @copyright  2022 Sara Arjona <sara@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_callforpaper\preset
 */
final class preset_test extends \advanced_testcase {
    ...
    public function test_create_from_plugin(): void {
        ...
        $this->assertEquals(get_string('modulename', "callforpaperpreset_$pluginname"), $result->name);
        $this->assertEquals($pluginname, $result->shortname);
        $this->assertEquals(get_string('modulename_help', "callforpaperpreset_$pluginname"), $result->description);
    ...
    public function test_export(): void {
        ...
        foreach (manager::TEMPLATES_LIST as $templatename => $notused) {
            callforpaper_generate_default_template($activity, $templatename);
        }
    ...
    /**
     * Call for paper provider for test_is_directory_a_preset().
     *
     * @return array
     */
    public static function is_directory_a_preset_provider(): array {
        ...
        return [
            'Valid preset directory' => [
                'directory' => $CFG->dirroot . '/mod/callforpaper/preset/imagegallery',
                'expected' => true,
            ],
            'Invalid preset directory' => [
                'directory' => $CFG->dirroot . '/mod/callforpaper/field/checkbox',
                'expected' => false,
            ],
    ...
    /**
     * Call for paper provider for generate_preset_xml().
     *
     * @return array
     */
    ...
    public function test_can_manage(): void {
        ...
        // Create course, callforpaper activity and users.
        $course = $this->getDataGenerator()->create_course();
        ...
        $adminpreset = $plugingenerator->create_preset($callforpaper, $record);
        ...
        $teacherpreset = $plugingenerator->create_preset($callforpaper, $record);
    ...
    public function test_get_sample_entries(): void {
        ...
        foreach ($entries as $entry) {
            ...
            $this->assertEquals($activity->id, $entry->callforpaperid);
    ...
    public function test_get_template_content(): void {
        ...
        // Module callforpaper with templates.
        $templates = [
