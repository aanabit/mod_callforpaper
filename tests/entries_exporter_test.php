...
final class entries_exporter_test extends \advanced_testcase {
    ...
    /**
     * Call for paper provider method for self::test_get_records_count.
     *
     ...
     * @covers \mod_callforpaper\local\exporter\entries_exporter::add_file_from_string
     * @covers \mod_callforpaper\local\exporter\entries_exporter::file_exists
    ...
    /**
     * Call for paper provider method for self::test_add_file_from_string.
     *
     * @return array data for testing
     */
     ...
     *
     * @covers \mod_callforpaper\local\exporter\entries_exporter::create_unique_filename
    ...
    /**
     * Call for paper provider method for self::test_create_unique_filename.
     *
     * @return array data for testing
     */
