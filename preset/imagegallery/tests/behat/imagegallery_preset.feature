@mod @mod_callforpaper @callforpaperpreset @callforpaper_preset_imagegallery
Feature: Users can use the Image gallery preset
  In order to create an Image gallery callforpaper
  As a user
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | callforpaper     | Mountain landscapes | Callforpaper intro | C1     | callforpaper1    |
    ...
    And the following "mod_callforpaper > entries" exist:
      | callforpaper | user      | title           | description                                  | image             |
      | callforpaper1    | student1  | First image     | This is the description text for image 1     | first.png         |
      | callforpaper1    | teacher1  | Second image    | And this is the description text for image 2 | second.png        |

  @javascript
  Scenario: Users view entries
    When I am on the "Mountain landscapes" "callforpaper activity" page logged in as student1
  ...
  Scenario: Users can search entries
    Given I am on the "Mountain landscapes" "callforpaper activity" page logged in as student1
