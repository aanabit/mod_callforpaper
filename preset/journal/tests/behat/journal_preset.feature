@mod @mod_callforpaper @callforpaperpreset @callforpaperpreset_journal
Feature: Users can use the Journal preset
  In order to create a Journal callforpaper
  As a user
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | callforpaper     | Student reflections    | Call for paper intro | C1     | callforpaper1    |
    And I am on the "Student reflections" "callforpaper activity" page logged in as teacher1
    ...
    And the following "mod_callforpaper > entries" exist:
      | callforpaper | user      | Title                           | Content                                  |
      | callforpaper1    | student1  | Reflection created by student   | This is the content for the entry 1      |
      | callforpaper1    | teacher1  | Reflection created by teacher   | And this is the content for the entry 2  |

  @javascript
  Scenario: Journal. Users view entries
    When I am on the "Student reflections" "callforpaper activity" page logged in as student1
  ...
  Scenario: Journal. Users can search entries
    Given I am on the "Student reflections" "callforpaper activity" page logged in as student1
  ...
  Scenario: Journal. Renaming a field should affect the template
    Given I am on the "Student reflections" "callforpaper activity" page logged in as teacher1
  ...
  Scenario: Journal. Has otherfields tag
    Given the following "mod_callforpaper > fields" exist:
      ...
      | callforpaper1    | text | Extra field | Test field description |
    And I am on the "Student reflections" "callforpaper activity" page logged in as teacher1
