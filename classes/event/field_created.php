...
/**
 * The mod_callforpaper field created event.
 *
...
/**
 * The mod_callforpaper field created event class.
 *
...
class field_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfieldcreated', 'mod_callforpaper');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the field with id '$this->objectid' for the callforpaper activity " .
