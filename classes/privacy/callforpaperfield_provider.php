...
/**
 * Contains interface callforpaperfield_provider
 *
...
/**
 * Interface callforpaperfield_provider, all callforpaperfield plugins need to implement it
 *
 * @package mod_callforpaper
 * @copyright 2018 Marina Glancy
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
interface callforpaperfield_provider extends
        \core_privacy\local\request\plugin\subplugin_provider,

        // The callforpaper subplugins do not need to do anything themselves for the shared_userlist.
     ...
     *
     * Callforpaperfield plugins providers should implement this method to:
     ...
     *
     * Sample implementation (from callforpaperfield_textarea):
     *
     *    $defaultvalue->content = writer::with_context($context)
     *        ->rewrite_pluginfile_urls([$recordobj->id, $contentobj->id], 'mod_callforpaper', 'content', $contentobj->id,
     ...
     *
     * Usually callforpaperfield plugins do not store anything and this method will be empty.
     *
     * @param \context_module $context
     * @param \stdClass $recordobj record from DB table {callforpaper_records}
     * @param \stdClass $fieldobj record from DB table {callforpaper_fields}
