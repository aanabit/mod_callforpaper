...
class record_exporter extends exporter {
    ...
    protected static function define_properties() {
        ...
        return array(
            ...
            'callforpaperid' => array(
                'type' => PARAM_INT,
                'description' => 'The callforpaper id this record belongs to.',
                'default' => 0,
            ),
            'timecreated' => array(
                'type' => PARAM_INT,
            ...
            'approved' => array(
                'type' => PARAM_BOOL,
                'description' => 'Whether the entry has been approved (if the callforpaper is configured in that way).',
                'default' => 0,
            ),
        );
    }
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $values = array(
            'canmanageentry' => callforpaper_user_can_manage_entry($this->data, $this->related['callforpaper'], $this->related['context']),
        );
        ...
        $values['tags'] = \core_tag\external\util::get_item_tags('mod_callforpaper', 'callforpaper_records', $this->data->id);
