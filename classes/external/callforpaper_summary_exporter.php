...
/**
 * Class for exporting partial callforpaper data.
 *
...
/**
 * Class for exporting partial callforpaper data (some fields are only viewable by admins).
 *
 * @copyright  2017 Juan Leyva <juan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class callforpaper_summary_exporter extends exporter {
    ...
    protected static function define_properties() {
        ...
        return array(
            'id' => array(
                'type' => PARAM_INT,
                'description' => 'Call for paper id'),
            'course' => array(
                'type' => PARAM_INT,
                'description' => 'Course id'),
            'name' => array(
                'type' => PARAM_RAW,
                'description' => 'Call for paper name'),
            'intro' => array(
                'type' => PARAM_RAW,
                'description' => 'The Call for paper intro',
            ),
            'introformat' => array(
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $values = array(
            ...
            'introfiles' => external_util::get_area_files($context->id, 'mod_callforpaper', 'intro', false, false),
        );
