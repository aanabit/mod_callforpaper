...
abstract class entries_exporter {
     ...
     */
    abstract protected function get_callforpaper_file_content(): string;
     ...
     */
    abstract protected function get_export_callforpaper_file_extension(): string;
    ...
    public function send_file(bool $sendtouser = true): null|string {
        if (empty($this->filenamesinzip)) {
            if ($sendtouser) {
                send_file($this->get_callforpaper_file_content(),
                    $this->exportfilename . '.' . $this->get_export_callforpaper_file_extension(),
                    null, 0, true, true);
                return null;
            } else {
                return $this->get_callforpaper_file_content();
            }
        }
        $this->add_file_from_string($this->exportfilename . '.' . $this->get_export_callforpaper_file_extension(),
            $this->get_callforpaper_file_content(), '/');
