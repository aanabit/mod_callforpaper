...
/**
 * Renderable class for the action bar elements in the fields mapping page in the callforpaper activity.
 *
...
class fields_mappings_action_bar implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        return [
            'tertiarytitle' => get_string('fieldmappings', 'mod_callforpaper'),
            'hasback' => true,
            'backtitle' => get_string('back'),
            'backurl' => new \moodle_url('/mod/callforpaper/preset.php', ['d' => $this->id]),
        ];
    }
}
