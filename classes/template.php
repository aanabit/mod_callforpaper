...
class template {
    ...
    protected function get_tag_approvalstatus_replacement(stdClass $entry, bool $canmanageentry): string {
        ...
        return ($entry->approved) ? html_writer::div(get_string('approved', 'callforpaper'), 'mod-callforpaper-approval-status-badge')
            : html_writer::div(get_string('notapproved', 'callforpaper'), 'mod-callforpaper-approval-status-badge');
    }
