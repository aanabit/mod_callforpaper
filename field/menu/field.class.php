...
class callforpaper_field_menu extends callforpaper_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        $str .= '</label>';
        $str .= html_writer::select($options, 'field_'.$this->field->id, $content, array('' => get_string('menuchoose', 'callforpaper')),
                                    ['id' => 'field_'.$this->field->id, 'class' => 'mod-callforpaper-input form-select']);
    ...
    function display_search_field($content = '') {
        ...
        $return = html_writer::label(get_string('fieldtypelabel', "callforpaperfield_" . $this->type),
            'menuf_' . $this->field->id, false, array('class' => 'accesshide'));
        $return .= html_writer::select($options, 'f_'.$this->field->id, $content, array('' => get_string('menuchoose', 'callforpaper')),
                ['class' => 'form-select']);
        return $return;
    }
