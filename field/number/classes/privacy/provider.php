...
/**
 * Privacy Subsystem implementation for callforpaperfield_number.
 *
 * @package    callforpaperfield_number
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace callforpaperfield_number\privacy;
use core_privacy\local\request\writer;
use mod_callforpaper\privacy\callforpaperfield_provider;

defined('MOODLE_INTERNAL') || die();
/**
 * Privacy Subsystem for callforpaperfield_number implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
