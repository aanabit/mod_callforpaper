...
class callforpaper_field_date extends callforpaper_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $content = (int)$DB->get_field('callforpaper_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid));
        } else {
            $content = time();
        }

        $str = '<div title="'.s($this->field->description).'" class="mod-callforpaper-input d-flex flex-wrap align-items-center">';
