...
class callforpaper_field_url extends callforpaper_field_base {
    var $type = 'url';
    /**
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($autolinkable) {
            ...
            $str .= '<span class="mod-callforpaper-input">' . get_string('url', 'callforpaper') . ':</span>';
            if (!empty($image)) {
                $str .= $image;
            }
            $str .= '</td><td>';
            ...
            $str .= '<tr><td align="right"><span class="mod-callforpaper-input">' . get_string('text', 'callforpaper') . ':</span></td><td>';
            ...
            $str .= $label;
            $str .= '<input type="text" name="field_'.$this->field->id.'_0" id="'.$fieldid.'" value="'.s($url).'"';
            $str .= ' size="40" class="mod-callforpaper-input form-control d-inline" />';
        ...
        $module = array('name'=>'callforpaper_urlpicker', 'fullpath'=>'/mod/callforpaper/callforpaper.js', 'requires'=>array('core_filepicker'));
        $PAGE->requires->js_init_call('M.callforpaper_urlpicker.init', array($options), true, $module);
        $str .= '</div>';
        return $str;
    }
    ...
    function display_browse_field($recordid, $template) {
        ...
        if ($this->field->param1) {
            ...
            $attributes = ['class' => 'callforpaper-field-link'];
