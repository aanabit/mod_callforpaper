...
/**
 * Privacy Subsystem implementation for callforpaperfield_text.
 *
 * @package    callforpaperfield_text
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace callforpaperfield_text\privacy;
use core_privacy\local\request\writer;
use mod_callforpaper\privacy\callforpaperfield_provider;

defined('MOODLE_INTERNAL') || die();
/**
 * Privacy Subsystem for callforpaperfield_text implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
