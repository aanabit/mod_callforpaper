...
/**
 * Privacy Subsystem implementation for callforpaperfield_file.
 *
 * @package    callforpaperfield_file
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace callforpaperfield_file\privacy;
use mod_callforpaper\privacy\callforpaperfield_provider;
use core_privacy\local\request\writer;

defined('MOODLE_INTERNAL') || die();
/**
 * Privacy Subsystem for callforpaperfield_file implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
