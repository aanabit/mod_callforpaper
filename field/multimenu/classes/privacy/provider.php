...
/**
 * Privacy Subsystem implementation for callforpaperfield_multimenu.
 *
 * @package    callforpaperfield_multimenu
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace callforpaperfield_multimenu\privacy;
use core_privacy\local\request\writer;
use mod_callforpaper\privacy\callforpaperfield_provider;

defined('MOODLE_INTERNAL') || die();
/**
 * Privacy Subsystem for callforpaperfield_multimenu implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
