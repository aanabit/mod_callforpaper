...
class callforpaper_field_multimenu extends callforpaper_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $contentfield = $DB->get_field('callforpaper_content', 'content', ['fieldid' => $this->field->id, 'recordid' => $recordid]);
        ...
        $str .= ' multiple="multiple" class="mod-callforpaper-input form-control">';
    ...
    function display_search_field($value = '') {
        ...
        $str .= html_writer::checkbox('f_'.$this->field->id.'_allreq', null, $allrequired,
            get_string('selectedrequired', 'callforpaper'), array('class' => 'me-1'));
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content  = $this->format_callforpaper_field_multimenu_content($value);
    ...
    function format_callforpaper_field_multimenu_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
