...
class callforpaper_field_checkbox extends callforpaper_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $content = $DB->get_field('callforpaper_content', 'content', ['fieldid' => $this->field->id, 'recordid' => $recordid]);
        ...
        foreach (explode("\n", $this->field->param1) as $checkbox) {
            ...
            $str .= 'value="' . s($checkbox) . '" class="mod-callforpaper-input me-1" ';
    ...
    function display_search_field($value='') {
        ...
        $requiredstr = get_string('selectedrequired', 'callforpaper');
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content = $this->format_callforpaper_field_checkbox_content($value);
    ...
    function format_callforpaper_field_checkbox_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
