...
class callforpaper_field_textarea extends callforpaper_field_base {
    ...
    public function get_callforpaper_content_preview(int $recordid): stdClass {
        return (object)[
            ...
            'recordid' => $recordid,
            'content' => get_string('sample', 'callforpaperfield_textarea'),
            'content1' => 1,
            'content2' => null,
            'content3' => null,
            'content4' => null,
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $text = file_prepare_draft_area($draftitemid, $this->context->id, 'mod_callforpaper', 'content', $content->id, $options, $text);
        } else {
            $draftitemid = file_get_unused_draft_itemid();
    ...
    function update_content($recordid, $value, $name='') {
        ...
        if (!empty($content->content)) {
            ...
            $options = $this->get_options();
            $content->content = file_save_draft_area_files($draftitemid, $this->context->id, 'mod_callforpaper', 'content', $content->id, $options, $content->content);
        }
        $rv = $DB->update_record('callforpaper_content', $content);
        return $rv;
    }
