...
/**
 * Privacy Subsystem implementation for callforpaperfield_textarea.
 *
 * @package    callforpaperfield_textarea
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace callforpaperfield_textarea\privacy;
...
/**
 * Privacy Subsystem for callforpaperfield_textarea implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements \core_privacy\local\metadata\null_provider,
    ...
    public static function export_callforpaper_content($context, $recordobj, $fieldobj, $contentobj, $defaultvalue) {
        ...
        $defaultvalue->content = writer::with_context($context)
            ->rewrite_pluginfile_urls($subcontext, 'mod_callforpaper', 'content', $contentobj->id,
